...
for setting in [
    ...
    for f in fs:
        for result in f['results']:
            ...
            if result['success']:
                attempt_results = result['attempt_results']
                ...
                for attempt_result in attempt_results:
                    ...
                    for single_trace in trace:
                        ...
                        # print(single_trace)
                        full_prompt, completion = construct_sample(single_trace['tactic'],single_trace['state_before'])
                        sample = {
...
train_data_name = 'mix3-r2'
output_dir = f'./samples/{train_data_name}'
